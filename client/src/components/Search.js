...
const calculateTFIDF = (term, document, documents) => {
  const termFrequency = document.text
    .toLowerCase()
    .split(" ")
...
// const calculateTFIDF = (term, document, documents) => {
//   const termFrequency = document
//     .toLowerCase()
//     .split(" ")
//     .map((word) => stemmer.stem(word)) // Stem each word in the document
//     .filter((stemmedWord) => stemmedWord === stemmer.stem(term)).length;
...
//       .toLowerCase()
//       .split(" ")
//       .map((word) => stemmer.stem(word)); // Stem each word in the query
